...
if __name__ == '__main__':
    ...
    src_filename = input("Input filename[test.mp3]:")
    if(src_filename == ""):
        src_filename = "test.mp3"

    dst_filename = input("Output filename[test.wav]:")
    if(dst_filename == ""):
        dst_filename = "test.wav"

    frame_cnt_limit = input("Limit number of frames decoded(0=no_limit)[100]:")
    if(frame_cnt_limit == ""):
        frame_cnt_limit = 100
